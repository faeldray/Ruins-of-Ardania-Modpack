...
addBrewWithUpgrades(
  awkward, <minecraft:emerald>, "potioncore:revival",
  "potioncore:strong_revival", "potioncore:long_revival"
);
addBrewWithUpgrades(
  awkward, <minecraft:feather>, "potioncore:slow_fall",
  "potioncore:strong_slow_fall", "potioncore:long_slow_fall"
);
addBrewWithUpgradesFromBase(
  "potioncore:slow_fall", <minecraft:sugar>, "potioncore:flight",
...
addBrewWithUpgrades(
  awkward, <minecraft:web>, "potioncore:climb",
  null, "potioncore:long_climb"
);
addBrewWithUpgrades(
  awkward, <minecraft:experience_bottle>, "potioncore:repair",
...
addBrewWithConversions(
  "potioncore:teleport", <minecraft:bed>, "potioncore:teleport_spawn"
);
addBrewWithConversions(
...
addBrewWithUpgrades(
  awkward, <minecraft:waterlily>, "potioncore:bless",
